let stage = 0,
  ...
  container = document.querySelector("#anchors"),
...
const quiz = (_) => {
  ...
  switch (stage) {
    case 0:
      ...
      info.innerHTML =
        "La compra asistida utiliza Inteligencia Artificial para recomendarte productos";

      noButton.onclick = (_) => {
        window.location.href = "/store";
      };
      yesButton.onclick = (_) => {
        preferences.assistedShopping = true;
        stage++;
        quiz();
      };
      break;
    case 1:
      title.innerHTML =
        "¿Te interesan los productos elaborados artesanalmente?";
      info.innerHTML =
        "Estos datos serán utilizados para recomendarte productos nuevos";
    ...
    case 2:
      ...
      info.innerHTML = "Te recomendaremos productos que te sirvan.";
